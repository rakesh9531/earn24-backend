...
exports.MLM_CONFIG = {
    ...
    PROMOTION_CRITERIA: {
        ...
        'DISTRIBUTOR_GOLD': { downline_rank_required: 'DISTRIBUTOR_SILVER', count: 2, aggregate_bv_required: 50000 },
        'DISTRIBUTOR_DIAMOND': { downline_rank_required: 'DISTRIBUTOR_GOLD', count: 2, aggregate_bv_required: 100000 },
        'LEADER': { downline_rank_required: 'DISTRIBUTOR_DIAMOND', count: 2, self_bv_required: 10000 },
        'TEAM_LEADER': { downline_rank_required: 'LEADER', count: 2 },
        'ASSISTANT_SUPERVISOR': { downline_rank_required: 'TEAM_LEADER', count: 2, other_legs_bv_required: 100000 },
        ...
        'SR_MANAGER': { downline_rank_required: 'MANAGER', count: 2, repurchase_bv_12_months_required: 12000, other_legs_bv_required: 200000 },
        'DIRECTOR': { downline_rank_required: ['MANAGER', 'SR_MANAGER'], count: 14, required_sr_managers_count: 7 },
    },
